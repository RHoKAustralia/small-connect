...
class AgenciesControllerTest < ActionController::TestCase
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post :create, agency: { address: @agency.address, description: @agency.description, name: @agency.name, services: @agency.services }
    end
  ...
  test "should update agency" do
    patch :update, id: @agency, agency: { address: @agency.address, description: @agency.description, name: @agency.name, services: @agency.services }
    assert_redirected_to agency_path(assigns(:agency))
  end
